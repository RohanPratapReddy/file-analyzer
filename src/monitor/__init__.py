...
Public API::
    ...
    from src.monitor import RepositoryMonitor, ChangeDiffDatabase
...
or as a standalone process (see ``src/__main__.py``)::

    python -m src monitor /path/to/repo --interval 2
