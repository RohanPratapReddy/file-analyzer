...
:mod:`src.document.evaluation_metrics` into a runnable scoring pass and emits
...
* **LLM-judge metrics** (C3 RAG faithfulness / answer-relevancy /
  ...
  - :class:`LlmJudge` drives a real agent through
    :class:`~src.document.dynamic_engine.ProviderRunner` /
    :class:`~src.document.agent_mcp.AgentConnector` (Claude Code, Gemini,
