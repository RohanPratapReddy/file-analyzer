...
previously hard-coded inside the Go reader program. The Python builder
([[builder]]) turns this catalog into real ``CREATE VIEW`` objects in the output
database (and into the ``.sql`` dump); the Go reader then simply reads those
installed views (``SELECT * FROM v_<name>``) instead of re-embedding the query
SQL.
...
VIEW_CATALOG: List[ViewDef] = [
    ...
    _v(
        ...
        ("classes_table", "junction_class_methods"),
        """
    ...
    _v(
        "schema_foreign_key_edges",
        ("schema_keys_table", "schema_tables_table"),
        """
    ...
    _v(
        "schema_top_indexed_tables",
        ("schema_indexes_table", "schema_tables_table"),
        """
    ...
    _v(
        ...
        ("schema_file_index", "file_details"),
        """
    ...
    _v(
        "data_top_correlations",
        ("data_relations_table", "data_datasets_table"),
        """
    ...
    _v(
        "data_largest_tensors",
        ("data_tensors_table", "data_datasets_table"),
        """
