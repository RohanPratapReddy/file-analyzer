...
Only SQLite (what AnalysisEngine produces / the Go reader opens) and
...
def views_ddl(
    ...
    lines: List[str] = [
        f"-- Analysis views ({d}) -- generated from file_analyzer.views.catalog",
...
def append_views_to_sql_dump(
    ...
    which loads the dump (e.g. the Go reader's one-time snapshot) gets the
